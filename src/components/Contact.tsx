      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div>
              <h4 className="text-xl font-semibold mb-4">¿Por qué conectar conmigo?</h4>
              <ul className="space-y-2 text-blue-100">
                <li className="flex items-start gap-2">
                  <CheckCircle size={16} className="mt-1 text-green-400 flex-shrink-0 animate-pulse" />
                  <span>Experiencia en análisis de datos e inteligencia artificial</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle size={16} className="mt-1 text-green-400 flex-shrink-0 animate-pulse" style={{animationDelay: '0.5s'}} />
                  <span>Formación técnica sólida en ingeniería y química</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle size={16} className="mt-1 text-green-400 flex-shrink-0 animate-pulse" style={{animationDelay: '1s'}} />
                  <span>Habilidades interpersonales desarrolladas</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle size={16} className="mt-1 text-green-400 flex-shrink-0 animate-pulse" style={{animationDelay: '1.5s'}} />
